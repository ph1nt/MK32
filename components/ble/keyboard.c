...
#include "keylayouts.h"
		{ CIRCUMFLEX_BITS, ACUTE_ACCENT_BITS, GRAVE_ACCENT_BITS, TILDE_BITS,
				DIAERESIS_BITS }, { DEADKEY_CIRCUMFLEX, DEADKEY_ACUTE_ACCENT,
				DEADKEY_GRAVE_ACCENT, DEADKEY_TILDE, DEADKEY_DIAERESIS } };
...
#include "keylayouts.h"
				{ CIRCUMFLEX_BITS, ACUTE_ACCENT_BITS, GRAVE_ACCENT_BITS }, {
						DEADKEY_CIRCUMFLEX, DEADKEY_ACUTE_ACCENT,
...
#include "keylayouts.h"
		{ CIRCUMFLEX_BITS, ACUTE_ACCENT_BITS, GRAVE_ACCENT_BITS, DIAERESIS_BITS,
				CEDILLA_BITS }, { DEADKEY_CIRCUMFLEX, DEADKEY_ACUTE_ACCENT,
				DEADKEY_GRAVE_ACCENT, DEADKEY_DIAERESIS, DEADKEY_CEDILLA } };
const uint16_t deadkey_CAINT[2][7] = {
#include "undefkeylayouts.h"
#define LAYOUT_CANADIAN_MULTILINGUAL
#include "keylayouts.h"
		{ CIRCUMFLEX_BITS, ACUTE_ACCENT_BITS, GRAVE_ACCENT_BITS, DIAERESIS_BITS,
				CEDILLA_BITS, TILDE_BITS, RING_ABOVE_BITS }, {
				DEADKEY_CIRCUMFLEX, DEADKEY_ACUTE_ACCENT, DEADKEY_GRAVE_ACCENT,
				DEADKEY_DIAERESIS, DEADKEY_CEDILLA, DEADKEY_TILDE,
				DEADKEY_RING_ABOVE } };
...
#include "keylayouts.h"
		{ CIRCUMFLEX_BITS, GRAVE_ACCENT_BITS, TILDE_BITS, DIAERESIS_BITS }, {
				DEADKEY_CIRCUMFLEX, DEADKEY_GRAVE_ACCENT, DEADKEY_TILDE,
				DEADKEY_DIAERESIS } };
...
#include "keylayouts.h"
				{ CIRCUMFLEX_BITS, ACUTE_ACCENT_BITS, GRAVE_ACCENT_BITS,
						DIAERESIS_BITS }, { DEADKEY_CIRCUMFLEX,
...
#define LAYOUT_IRISH
#include "keylayouts.h"
		{ ACUTE_ACCENT_BITS, GRAVE_ACCENT_BITS }, { DEADKEY_ACUTE_ACCENT,
				DEADKEY_GRAVE_ACCENT } };
...
#include "keylayouts.h"
		{ CIRCUMFLEX_BITS, ACUTE_ACCENT_BITS, GRAVE_ACCENT_BITS,
				RING_ABOVE_BITS, DIAERESIS_BITS }, { DEADKEY_CIRCUMFLEX,
				DEADKEY_ACUTE_ACCENT, DEADKEY_GRAVE_ACCENT, DEADKEY_RING_ABOVE,
				DEADKEY_DIAERESIS } };
...
#define LAYOUT_CZECH
#include "keylayouts.h"
		{/*CIRCUMFLEX_BITS,*/DOUBLE_ACUTE_BITS, CEDILLA_BITS, DEGREE_SIGN_BITS,
				CARON_BITS, ACUTE_ACCENT_BITS, BREVE_BITS, /*GRAVE_ACCENT_BITS,*/
				DOT_ABOVE_BITS, /*DIAERESIS_BITS, */OGONEK_BITS }, {/*DEADKEY_CIRCUMFLEX,*/
				DEADKEY_DOUBLE_ACUTE, DEADKEY_CEDILLA, DEADKEY_DEGREE_SIGN,
				DEADKEY_CARON, DEADKEY_ACUTE_ACCENT, DEADKEY_BREVE, /*DEADKEY_GRAVE_ACCENT,*/
...
#include "keylayouts.h"
		{ CIRCUMFLEX_BITS, DOUBLE_ACUTE_BITS, CEDILLA_BITS, DEGREE_SIGN_BITS,
				CARON_BITS, ACUTE_ACCENT_BITS, BREVE_BITS, DOT_ABOVE_BITS,
				DIAERESIS_BITS, OGONEK_BITS }, { DEADKEY_CIRCUMFLEX,
				DEADKEY_DOUBLE_ACUTE, DEADKEY_CEDILLA, DEADKEY_DEGREE_SIGN,
				DEADKEY_CARON, DEADKEY_ACUTE_ACCENT, DEADKEY_BREVE,
				DEADKEY_DOT_ABOVE, DEADKEY_DIAERESIS, DEADKEY_OGONEK } };
///@endcond
 ...
 * */
const uint16_t* keycodes_deadkey_bits[] = { deadkey_USINT[0], deadkey_DE[0],
		deadkey_DEMAC[0], deadkey_CAFR[0], deadkey_CAINT[0], deadkey_UK[0],
		deadkey_FI[0], deadkey_FR[0], deadkey_DK[0], deadkey_NW[0],
		deadkey_SW[0], deadkey_ES[0], deadkey_PT[0], deadkey_IT[0],
		deadkey_PTBR[0], deadkey_FRBE[0], deadkey_DESW[0], deadkey_FRSW[0],
		deadkey_ESLAT[0], deadkey_IR[0], deadkey_IC[0], deadkey_TK[0],
		deadkey_CZ[0], deadkey_SR[0] };
 ...
 * LAYOUT_US_ENGLISH (no deadkeys at all)
 * */
const uint16_t* keycodes_deadkey[] = { deadkey_USINT[1], deadkey_DE[1],
		deadkey_DEMAC[1], deadkey_CAFR[1], deadkey_CAINT[1], deadkey_UK[1],
		deadkey_FI[1], deadkey_FR[1], deadkey_DK[1], deadkey_NW[1],
		deadkey_SW[1], deadkey_ES[1], deadkey_PT[1], deadkey_IT[1],
		deadkey_PTBR[1], deadkey_FRBE[1], deadkey_DESW[1], deadkey_FRSW[1],
		deadkey_ESLAT[1], deadkey_IR[1], deadkey_IC[1], deadkey_TK[1],
		deadkey_CZ[1], deadkey_SR[1] };
...
#define LAYOUT_US_ENGLISH
#include "keylayouts.h"
		{ ASCII_20, ASCII_21, ASCII_22, ASCII_23, ASCII_24, ASCII_25, ASCII_26,
				ASCII_27, ASCII_28, ASCII_29, ASCII_2A, ASCII_2B, ASCII_2C,
				ASCII_2D, ASCII_2E, ASCII_2F, ASCII_30, ASCII_31, ASCII_32,
				ASCII_33, ASCII_34, ASCII_35, ASCII_36, ASCII_37, ASCII_38,
				ASCII_39, ASCII_3A, ASCII_3B, ASCII_3C, ASCII_3D, ASCII_3E,
				ASCII_3F, ASCII_40, ASCII_41, ASCII_42, ASCII_43, ASCII_44,
				ASCII_45, ASCII_46, ASCII_47, ASCII_48, ASCII_49, ASCII_4A,
				ASCII_4B, ASCII_4C, ASCII_4D, ASCII_4E, ASCII_4F, ASCII_50,
				ASCII_51, ASCII_52, ASCII_53, ASCII_54, ASCII_55, ASCII_56,
				ASCII_57, ASCII_58, ASCII_59, ASCII_5A, ASCII_5B, ASCII_5C,
				ASCII_5D, ASCII_5E, ASCII_5F, ASCII_60, ASCII_61, ASCII_62,
				ASCII_63, ASCII_64, ASCII_65, ASCII_66, ASCII_67, ASCII_68,
				ASCII_69, ASCII_6A, ASCII_6B, ASCII_6C, ASCII_6D, ASCII_6E,
				ASCII_6F, ASCII_70, ASCII_71, ASCII_72, ASCII_73, ASCII_74,
				ASCII_75, ASCII_76, ASCII_77, ASCII_78, ASCII_79, ASCII_7A,
				ASCII_7B, ASCII_7C, ASCII_7D, ASCII_7E, ASCII_7F },
#include "undefkeylayouts.h"
#define LAYOUT_US_INTERNATIONAL
#include "keylayouts.h"
		{ ASCII_20, ASCII_21, ASCII_22, ASCII_23, ASCII_24, ASCII_25, ASCII_26,
...
uint16_t unicode_to_keycode(uint16_t cpoint, uint8_t locale) {
	...
	if (cpoint < 32) {
		if (cpoint == 10) {
			ESP_LOGI(LOG_TAG, "cpoint %d, locale %d, mask %d, key %d", cpoint,
					locale, keycodes_masks[locale][3], KEY_ENTER);
			return KEY_ENTER & keycodes_masks[locale][3];
		}
		if (cpoint == 11) {
			ESP_LOGI(LOG_TAG, "cpoint %d, locale %d, mask %d, key %d", cpoint,
					locale, keycodes_masks[locale][3], KEY_TAB);
	...
	if (cpoint < 128) {
		...
		ESP_LOGI(LOG_TAG, "cpoint %d, locale %d, mask --, key %d", cpoint,
				locale, keycodes_ascii[locale][cpoint - 0x20]);
	...
	if (cpoint < 0x100) {
		if (locale == LAYOUT_US_ENGLISH) {
			ESP_LOGE(LOG_TAG,
					"locale is LAYOUT_US_ENGLISH, no unicode available");
			return 0;
		} else {
			ESP_LOGI(LOG_TAG, "cpoint %d, locale %d, mask --, key %d", cpoint,
					locale, keycodes_iso_8859_1[locale - 1][cpoint - 0xA0]);
...
uint16_t deadkey_to_keycode(uint16_t keycode, uint8_t locale) {
	...
	if (keycode == 0)
		return 0;
	ESP_LOGI(LOG_TAG, "deadkeys: applying mask 0x%X, result: %d",
			keycodes_masks[locale][2], keycode);
	for (uint8_t i = 0; i < sizeof(keycodes_deadkey_bits[locale]); i++) {
		if (keycode == keycodes_deadkey_bits[locale][i]) {
			ESP_LOGI(LOG_TAG, "deadkey found, index: %d, deadkey: %d", i,
					keycodes_deadkey[locale][i]);
...
uint8_t keycode_to_modifier(uint16_t keycode, uint8_t locale) {
	uint8_t modifier = 0;
	if (keycode & keycodes_masks[locale][0])
		modifier |= MODIFIERKEY_SHIFT;
	if (keycode & keycodes_masks[locale][1])
		modifier |= MODIFIERKEY_RIGHT_ALT;
	if (keycode & keycodes_masks[locale][4])
		modifier |= MODIFIERKEY_RIGHT_CTRL;
	if (modifier)
		ESP_LOGI(LOG_TAG, "found modifiers: %X", modifier);
	return modifier;
}
...
uint16_t parseIdentifierToKeycode(char* keyidentifier) {
	if (COMP(keyidentifier, "KEY_1"))
		return KEY_1;
	if (COMP(keyidentifier, "KEY_2"))
		return KEY_2;
	if (COMP(keyidentifier, "KEY_3"))
		return KEY_3;
	if (COMP(keyidentifier, "KEY_4"))
		return KEY_4;
	if (COMP(keyidentifier, "KEY_5"))
		return KEY_5;
	if (COMP(keyidentifier, "KEY_6"))
		return KEY_6;
	if (COMP(keyidentifier, "KEY_7"))
		return KEY_7;
	if (COMP(keyidentifier, "KEY_8"))
		return KEY_8;
	if (COMP(keyidentifier, "KEY_9"))
		return KEY_9;
	if (COMP(keyidentifier, "KEY_0"))
		return KEY_0;

	if (COMP(keyidentifier, "KEY_F1"))
		return KEY_F1;
	if (COMP(keyidentifier, "KEY_F2"))
		return KEY_F2;
	if (COMP(keyidentifier, "KEY_F3"))
		return KEY_F3;
	if (COMP(keyidentifier, "KEY_F4"))
		return KEY_F4;
	if (COMP(keyidentifier, "KEY_F5"))
		return KEY_F5;
	if (COMP(keyidentifier, "KEY_F6"))
		return KEY_F6;
	if (COMP(keyidentifier, "KEY_F7"))
		return KEY_F7;
	if (COMP(keyidentifier, "KEY_F8"))
		return KEY_F8;
	if (COMP(keyidentifier, "KEY_F9"))
		return KEY_F9;
	if (COMP(keyidentifier, "KEY_F10"))
		return KEY_F10;
	if (COMP(keyidentifier, "KEY_F11"))
		return KEY_F11;
	if (COMP(keyidentifier, "KEY_F12"))
		return KEY_F12;
	if (COMP(keyidentifier, "KEY_F13"))
		return KEY_F13;
	if (COMP(keyidentifier, "KEY_F14"))
		return KEY_F14;
	if (COMP(keyidentifier, "KEY_F15"))
		return KEY_F15;
	if (COMP(keyidentifier, "KEY_F16"))
		return KEY_F16;
	if (COMP(keyidentifier, "KEY_F17"))
		return KEY_F17;
	if (COMP(keyidentifier, "KEY_F18"))
		return KEY_F18;
	if (COMP(keyidentifier, "KEY_F19"))
		return KEY_F19;
	if (COMP(keyidentifier, "KEY_F20"))
		return KEY_F20;
	if (COMP(keyidentifier, "KEY_F21"))
		return KEY_F21;
	if (COMP(keyidentifier, "KEY_F22"))
		return KEY_F22;
	if (COMP(keyidentifier, "KEY_F23"))
		return KEY_F23;
	if (COMP(keyidentifier, "KEY_F24"))
		return KEY_F24;

	if (COMP(keyidentifier, "KEY_RIGHT"))
		return KEY_RIGHT;
	if (COMP(keyidentifier, "KEY_LEFT"))
		return KEY_LEFT;
	if (COMP(keyidentifier, "KEY_DOWN"))
		return KEY_DOWN;
	if (COMP(keyidentifier, "KEY_UP"))
		return KEY_UP;

	if (COMP(keyidentifier, "KEY_ENTER"))
		return KEY_ENTER;
	if (COMP(keyidentifier, "KEY_ESC"))
		return KEY_ESC;
	if (COMP(keyidentifier, "KEY_BACKSPACE"))
		return KEY_BACKSPACE;
	if (COMP(keyidentifier, "KEY_TAB"))
		return KEY_TAB;
	if (COMP(keyidentifier, "KEY_HOME"))
		return KEY_HOME;
	if (COMP(keyidentifier, "KEY_PAGE_UP"))
		return KEY_PAGE_UP;
	if (COMP(keyidentifier, "KEY_PAGE_DOWN"))
		return KEY_PAGE_DOWN;
	if (COMP(keyidentifier, "KEY_DELETE"))
		return KEY_DELETE;
	if (COMP(keyidentifier, "KEY_INSERT"))
		return KEY_INSERT;
	if (COMP(keyidentifier, "KEY_END"))
		return KEY_END;
	if (COMP(keyidentifier, "KEY_NUM_LOCK"))
		return KEY_NUM_LOCK;
	if (COMP(keyidentifier, "KEY_SCROLL_LOCK"))
		return KEY_SCROLL_LOCK;
	if (COMP(keyidentifier, "KEY_SPACE"))
		return KEY_SPACE;
	if (COMP(keyidentifier, "KEY_CAPS_LOCK"))
		return KEY_CAPS_LOCK;
	if (COMP(keyidentifier, "KEY_PAUSE"))
		return KEY_PAUSE;
	if (COMP(keyidentifier, "KEY_SHIFT"))
		return MODIFIERKEY_SHIFT;
	if (COMP(keyidentifier, "KEY_CTRL"))
		return MODIFIERKEY_CTRL;
	if (COMP(keyidentifier, "KEY_ALT"))
		return MODIFIERKEY_ALT;
	if (COMP(keyidentifier, "KEY_RIGHT_ALT"))
		return KEY_RIGHT_ALT;
	if (COMP(keyidentifier, "KEY_GUI"))
		return MODIFIERKEY_GUI;
	if (COMP(keyidentifier, "KEY_RIGHT_GUI"))
		return KEY_RIGHT_GUI;

	if (COMP(keyidentifier, "KEY_MEDIA_POWER"))
		return KEY_MEDIA_POWER;
	if (COMP(keyidentifier, "KEY_MEDIA_RESET"))
		return KEY_MEDIA_RESET;
	if (COMP(keyidentifier, "KEY_MEDIA_SLEEP"))
		return KEY_MEDIA_SLEEP;
	if (COMP(keyidentifier, "KEY_MEDIA_MENU"))
		return KEY_MEDIA_MENU;
	if (COMP(keyidentifier, "KEY_MEDIA_SELECTION"))
		return KEY_MEDIA_SELECTION;
	if (COMP(keyidentifier, "KEY_MEDIA_ASSIGN_SEL"))
		return KEY_MEDIA_ASSIGN_SEL;
	if (COMP(keyidentifier, "KEY_MEDIA_MODE_STEP"))
		return KEY_MEDIA_MODE_STEP;
	if (COMP(keyidentifier, "KEY_MEDIA_RECALL_LAST"))
		return KEY_MEDIA_RECALL_LAST;
	if (COMP(keyidentifier, "KEY_MEDIA_QUIT"))
		return KEY_MEDIA_QUIT;
	if (COMP(keyidentifier, "KEY_MEDIA_HELP"))
		return KEY_MEDIA_HELP;
	if (COMP(keyidentifier, "KEY_MEDIA_CHANNEL_UP"))
		return KEY_MEDIA_CHANNEL_UP;
	if (COMP(keyidentifier, "KEY_MEDIA_CHANNEL_DOWN"))
		return KEY_MEDIA_CHANNEL_DOWN;
	if (COMP(keyidentifier, "KEY_MEDIA_SELECT_DISC"))
		return KEY_MEDIA_SELECT_DISC;
	if (COMP(keyidentifier, "KEY_MEDIA_ENTER_DISC"))
		return KEY_MEDIA_ENTER_DISC;
	if (COMP(keyidentifier, "KEY_MEDIA_REPEAT"))
		return KEY_MEDIA_REPEAT;
	if (COMP(keyidentifier, "KEY_MEDIA_VOLUME"))
		return KEY_MEDIA_VOLUME;
	if (COMP(keyidentifier, "KEY_MEDIA_BALANCE"))
		return KEY_MEDIA_BALANCE;
	if (COMP(keyidentifier, "KEY_MEDIA_BASS"))
		return KEY_MEDIA_BASS;

	if (COMP(keyidentifier, "KEY_MEDIA_PLAY"))
		return KEY_MEDIA_PLAY;
	if (COMP(keyidentifier, "KEY_MEDIA_PAUSE"))
		return KEY_MEDIA_PAUSE;
	if (COMP(keyidentifier, "KEY_MEDIA_RECORD"))
		return KEY_MEDIA_RECORD;
	if (COMP(keyidentifier, "KEY_MEDIA_FAST_FORWARD"))
		return KEY_MEDIA_FAST_FORWARD;
	if (COMP(keyidentifier, "KEY_MEDIA_REWIND"))
		return KEY_MEDIA_REWIND;
	if (COMP(keyidentifier, "KEY_MEDIA_NEXT_TRACK"))
		return KEY_MEDIA_NEXT_TRACK;
	if (COMP(keyidentifier, "KEY_MEDIA_PREV_TRACK"))
		return KEY_MEDIA_PREV_TRACK;
	if (COMP(keyidentifier, "KEY_MEDIA_STOP"))
		return KEY_MEDIA_STOP;
	if (COMP(keyidentifier, "KEY_MEDIA_EJECT"))
		return KEY_MEDIA_EJECT;
	if (COMP(keyidentifier, "KEY_MEDIA_RANDOM_PLAY"))
		return KEY_MEDIA_RANDOM_PLAY;
	if (COMP(keyidentifier, "KEY_MEDIA_STOP_EJECT"))
		return KEY_MEDIA_STOP_EJECT;
	if (COMP(keyidentifier, "KEY_MEDIA_PLAY_PAUSE"))
		return KEY_MEDIA_PLAY_PAUSE;
	if (COMP(keyidentifier, "KEY_MEDIA_PLAY_SKIP"))
		return KEY_MEDIA_PLAY_SKIP;
	if (COMP(keyidentifier, "KEY_MEDIA_MUTE"))
		return KEY_MEDIA_MUTE;
	if (COMP(keyidentifier, "KEY_MEDIA_VOLUME_INC"))
		return KEY_MEDIA_VOLUME_INC;
	if (COMP(keyidentifier, "KEY_MEDIA_VOLUME_DEC"))
		return KEY_MEDIA_VOLUME_DEC;

	if (COMP(keyidentifier, "KEY_SYSTEM_POWER_DOWN"))
		return KEY_SYSTEM_POWER_DOWN;
	if (COMP(keyidentifier, "KEY_SYSTEM_SLEEP"))
		return KEY_SYSTEM_SLEEP;
	if (COMP(keyidentifier, "KEY_SYSTEM_WAKE_UP"))
		return KEY_SYSTEM_WAKE_UP;
	if (COMP(keyidentifier, "KEY_MINUS"))
		return KEY_MINUS;
	if (COMP(keyidentifier, "KEY_EQUAL"))
		return KEY_EQUAL;
	if (COMP(keyidentifier, "KEY_LEFT_BRACE"))
		return KEY_LEFT_BRACE;
	if (COMP(keyidentifier, "KEY_RIGHT_BRACE"))
		return KEY_RIGHT_BRACE;
	if (COMP(keyidentifier, "KEY_BACKSLASH"))
		return KEY_BACKSLASH;
	if (COMP(keyidentifier, "KEY_SEMICOLON"))
		return KEY_SEMICOLON;
	if (COMP(keyidentifier, "KEY_QUOTE"))
		return KEY_QUOTE;
	if (COMP(keyidentifier, "KEY_TILDE"))
		return KEY_TILDE;
	if (COMP(keyidentifier, "KEY_COMMA"))
		return KEY_COMMA;
	if (COMP(keyidentifier, "KEY_PERIOD"))
		return KEY_PERIOD;
	if (COMP(keyidentifier, "KEY_SLASH"))
		return KEY_SLASH;
	if (COMP(keyidentifier, "KEY_PRINTSCREEN"))
		return KEY_PRINTSCREEN;
	if (COMP(keyidentifier, "KEY_MENU"))
		return KEY_MENU;

	if (COMP(keyidentifier, "KEYPAD_SLASH"))
		return KEYPAD_SLASH;
	if (COMP(keyidentifier, "KEYPAD_ASTERIX"))
		return KEYPAD_ASTERIX;
	if (COMP(keyidentifier, "KEYPAD_MINUS"))
		return KEYPAD_MINUS;
	if (COMP(keyidentifier, "KEYPAD_PLUS"))
		return KEYPAD_PLUS;
	if (COMP(keyidentifier, "KEYPAD_ENTER"))
		return KEYPAD_ENTER;
	if (COMP(keyidentifier, "KEYPAD_1"))
		return KEYPAD_1;
	if (COMP(keyidentifier, "KEYPAD_2"))
		return KEYPAD_2;
	if (COMP(keyidentifier, "KEYPAD_3"))
		return KEYPAD_3;
	if (COMP(keyidentifier, "KEYPAD_4"))
		return KEYPAD_4;
	if (COMP(keyidentifier, "KEYPAD_5"))
		return KEYPAD_5;
	if (COMP(keyidentifier, "KEYPAD_6"))
		return KEYPAD_6;
	if (COMP(keyidentifier, "KEYPAD_7"))
		return KEYPAD_7;
	if (COMP(keyidentifier, "KEYPAD_8"))
		return KEYPAD_8;
	if (COMP(keyidentifier, "KEYPAD_9"))
		return KEYPAD_9;
	if (COMP(keyidentifier, "KEYPAD_0"))
		return KEYPAD_0;

	if (COMP(keyidentifier, "KEY_A"))
		return KEY_A;
	if (COMP(keyidentifier, "KEY_B"))
		return KEY_B;
	if (COMP(keyidentifier, "KEY_C"))
		return KEY_C;
	if (COMP(keyidentifier, "KEY_D"))
		return KEY_D;
	if (COMP(keyidentifier, "KEY_E"))
		return KEY_E;
	if (COMP(keyidentifier, "KEY_F"))
		return KEY_F;
	if (COMP(keyidentifier, "KEY_G"))
		return KEY_G;
	if (COMP(keyidentifier, "KEY_H"))
		return KEY_H;
	if (COMP(keyidentifier, "KEY_I"))
		return KEY_I;
	if (COMP(keyidentifier, "KEY_J"))
		return KEY_J;
	if (COMP(keyidentifier, "KEY_K"))
		return KEY_K;
	if (COMP(keyidentifier, "KEY_L"))
		return KEY_L;
	if (COMP(keyidentifier, "KEY_M"))
		return KEY_M;
	if (COMP(keyidentifier, "KEY_N"))
		return KEY_N;
	if (COMP(keyidentifier, "KEY_O"))
		return KEY_O;
	if (COMP(keyidentifier, "KEY_P"))
		return KEY_P;
	if (COMP(keyidentifier, "KEY_Q"))
		return KEY_Q;
	if (COMP(keyidentifier, "KEY_R"))
		return KEY_R;
	if (COMP(keyidentifier, "KEY_S"))
		return KEY_S;
	if (COMP(keyidentifier, "KEY_T"))
		return KEY_T;
	if (COMP(keyidentifier, "KEY_U"))
		return KEY_U;
	if (COMP(keyidentifier, "KEY_V"))
		return KEY_V;
	if (COMP(keyidentifier, "KEY_W"))
		return KEY_W;
	if (COMP(keyidentifier, "KEY_X"))
		return KEY_X;
	if (COMP(keyidentifier, "KEY_Y"))
		return KEY_Y;
	if (COMP(keyidentifier, "KEY_Z"))
		return KEY_Z;
...
uint8_t get_keycode(uint16_t cpoint, uint8_t locale, uint8_t *keycode_modifier,
	...
	uint8_t keycode = 0;
	keycode = parse_for_keycode(part, locale, keycode_modifier,
			deadkey_first_keystroke);
